  ...
  return (
    <>
      <motion.aside
        ...
        className="hidden md:flex bg-surface-container/95 backdrop-blur-sm border-r border-outline-variant/50 overflow-hidden shrink-0"
      >
        <AnimatePresence>
          {pinned && (
            <motion.div
      ...
      {!pinned && (
        ...
        >
          ...
          <AnimatePresence>
            {peeking && (
              <motion.aside
                className="absolute top-0 left-0 h-full w-[260px] bg-surface-container/95 backdrop-blur-sm border-r border-outline-variant/50 shadow-2xl flex flex-col z-30"
